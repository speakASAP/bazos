...
Expose a protected Bazos-owned order-affinity replay route so Marketing dry-run no longer receives HTTP 404, while failing closed because persisted Bazos orders do not currently retain replayable item lines.
...
- Response fails closed with zero events and explicit blockers.
