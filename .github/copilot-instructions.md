...
- **Authoritative path**: `/home/ssf/Documents/Github/bazos` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/bazos.git`, branch `main`.
