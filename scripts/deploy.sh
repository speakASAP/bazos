#!/bin/bash
# bazos-service Application Deployment Script
# Usage: ./scripts/deploy.sh
#
# This script deploys the bazos-service application to production using the
...
echo -e "${BLUE}╔════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║     bazos-service Application - Production Deployment      ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
if [ $DEPLOY_EXIT_CODE -eq 0 ]; then
    ...
    echo -e "${GREEN}╚════════════════════════════════════════════════════════════╝${NC}"
    echo ""
    echo "The bazos-service application has been deployed using blue/green deployment."
