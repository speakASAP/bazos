...
|---|---|---|
| Manual override signal visible | Pass | `services/aukro-service/src/ui/ui.assets.ts` renders `Manual override` when preview/profile/fields indicate manual overrides. |
