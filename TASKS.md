...
- 2026-07-02 goal-25-catalog-manual-review-metadata-adopted: Bazos catalog preview UI now surfaces Catalog manual override, source changed, and review required metadata without changing guarded publish queue or confirmation behavior.
