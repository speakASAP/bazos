...
Code -> services/bazos-service/src/ui/ui.assets.ts, scripts/verify-orders-lifecycle-ui.js.
Validation -> node scripts/verify-orders-lifecycle-ui.js passed; cd services/bazos-service && npm run build passed; focused OrdersService jest spec passed 14 tests.
